...
A link here means **influence or interoperability**, not bundled code, endorsement, or automatic trust. The v0.6.3 Astra Edition Skills are an original synthesis. Third-party repositories are not vendored or installed by default.
