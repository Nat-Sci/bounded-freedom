...
A link here means **influence or interoperability**, not bundled code, endorsement, or automatic trust. The v0.6.1 Astra Edition Skills are an original synthesis. Third-party repositories are not vendored or installed by default.
...
| Method plane | What disciplined process should this task follow? | Owned here: six research Skills plus one mathematical entry with three on-demand modules |
...
| --- | --- | --- |
| [Stan User's Guide](https://mc-stan.org/docs/stan-users-guide/index.html) | Statistical model construction, dependence, missingness, diagnostics, and generated-quantity patterns | Informs the `mathematical-methods` statistical module; Stan is an optional project runtime, not the method itself |
...
| --- | --- | --- | --- |
| `cost-efficient-orchestration` | [Agent Skills](https://agentskills.io/specification), [Codex subagents](https://learn.chatgpt.com/docs/agent-configuration/subagents), [Codex speed and Spark](https://learn.chatgpt.com/docs/agent-configuration/speed), [OpenAI Astra model guidance](https://developers.openai.com/api/docs/guides/latest-model?model=gpt-6-astra), [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness), [SciAgent](https://github.com/smestern/sciagent), [open-coscientist](https://github.com/jataware/open-coscientist) | Chief accountability, progressive Skill loading, bounded execution contracts, separate general and code fast routes, compact phase handoffs, a balanced opportunity gate, evidence-gated frontier control, lane exit decisions, route receipts, per-unit model choice, Spark-only authoritative quota preflight with privacy-minimized normalization, independent review, a portable host boundary, and bounded research-lineage handoffs | **Deferred:** measured routing thresholds, authoritative cost telemetry, durable event state, and cross-project lineage synchronization. **Excluded:** task-wide luxury/basic profiles, forced model-share quotas, standing crews, recursive delegation, required graph infrastructure, and automatic merging of upstream changes |
...
| `mathematical-methods` | [research-paper-code-study](https://github.com/baizhanxu/research-paper-code-study-codex-skill), [Stan User's Guide](https://mc-stan.org/docs/stan-users-guide/index.html), [WHO Child Growth Standards](https://www.who.int/tools/child-growth-standards/standards), [lifespan normative modeling guidance](https://elifesciences.org/articles/85082), [TRIPOD+AI](https://www.bmj.com/content/385/bmj-2023-078378), [PROBAST+AI](https://www.bmj.com/content/388/bmj-2024-082505), [STARD-AI](https://www.nature.com/articles/s41591-025-03953-8), [PyTorch autograd notes](https://docs.pytorch.org/docs/stable/notes/autograd.html), and [Theorem Proving in Lean 4](https://docs.lean-lang.org/theorem_proving_in_lean4/) | One discoverable entry with an artifact-first problem map and three on-demand modules: statistical modeling; neural-network mathematics; and loss, objective, and optimization analysis. The layer preserves evidence states, estimands and dependence, code-to-operator and gradient maps, profile-specific diagnostics, counterexamples, proof obligations, and one bounded checkpointed handoff | **Deferred:** deterministic equation, statistical, gradient, and program-analysis adapters plus an independent `formal-proof-verification` Skill after repeated demand. **Excluded:** independently discoverable math leaves, recursive execution, automatic model or weight selection, patient-level diagnosis, bundled runtimes, invented specifications, and sampled behavior as universal proof |
...
- Strict proof production and proof-assistant verification are explicit Future
  Work. The mathematical Skill and its modules may record definitions, assumptions,
...
3. **Load methods only when needed.** Six focused research Skills and one
   mathematical entry replace a giant standing prompt or a permanent team of
   agents; the mathematical entry opens only one specialized module at a time.
